...
$(".snap-container").scroll(function() {
    ...
    $("section:nth-child(" + nunumR[0] + ")").addClass('active');
...
$("li").click(function() {
	console.log((($(this).attr('data-slide-link')) * $('section').height()));
    $(".snap-container").animate({ scrollTop: ((($(this).attr('data-slide-link')) * $('section').height()) + (60 * ($(this).attr('data-slide-link') - 1)) }, 1500);
});